...
@section('content')
    <h3 class="page-title">@lang('global.setup.dashboardGraphtitle')</h3>


    <div class="row" ng-controller="temsSetupController1">
...
@section('javascript')
    <script>
        ...
        angular.module('tms').controller('temsSetupController1', function temsSetupController($scope, $http) {
            ...
            $scope.GetGraphData = function () {
                ...
                $http({
                    method : "get",
                    url : '{{ route('admin.users.getGraph',[$id,"dashboard"]) }}'
                }).then(function mySuccess(response) {
                    console.log(response.data.generated_data);
                    $scope.graphList = response.data.generated_data.filter(function(aData){
                        if(aData.is_dashboard==1){
                            return aData;
                        }
                    });
