                ...
                {{--<div class="form-group">--}}
                    ...
                    {{--<select class="form-control" id="player_id" name="player_id" value="{{ old('player_id') }}">>--}}
                        ...
                        {{--@foreach($players as $item)--}}
                            {{--<option value="{{$item->id}}" {{request()->has('player_id') && request()->player_id== $item->id? 'selected':''}}>players {{$item->id}}</option>--}}
                        {{--@endforeach--}}
    ...
    <script>
        ...
        window.onload = function() {
            ...
            var lineChart1 = new Chart(ctx1, {
                type: 'line',
                data: {
                    labels: {!! $player_information->pluck('wk')!!},
                    datasets: [{
                        label: "Breakfast",
            ...
            var lineChart4 = new Chart(ctx4, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: window.chartColors.red,
                        borderColor: window.chartColors.red,
                        data: [{{collect(collect($stranth_meter)->pull('extra_strength'))->implode(',')}}],
                        fill: false,
                    }, {
                        label: "Extra Cardio",
                        fill: false,
                        backgroundColor: window.chartColors.blue,
                        borderColor: window.chartColors.blue,
                        data: [{{collect(collect($stranth_meter)->pull('extra_cardio'))->implode(',')}}],
                    },{
                        label: "Extra Skill",
                        backgroundColor: window.chartColors.green,
                        borderColor: window.chartColors.green,
                        data: [{{collect(collect($stranth_meter)->pull('extra_skill'))->implode(',')}}],
                        fill: false,
                    }, {
                        label: "Watch Video",
                        fill: false,
                        backgroundColor: window.chartColors.yellow,
                        borderColor: window.chartColors.yellow,
                        data: [{{collect(collect($stranth_meter)->pull('watch_video'))->implode(',')}}],
                    }]
                },options: {
                    responsive: true,
                    title:{
